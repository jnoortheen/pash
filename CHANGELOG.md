...
## [0.20.0](https://github.com/jnoortheen/pash/compare/v0.19.0...0.20.0) (2025-02-04)


### ⚠ BREAKING CHANGES

* remove xonsh.api module
* replace the PLY based parser with the Rust based one
* remove ability to load external *.xsh files
* remove confusing hook_post_add_argument
* remove deprecated module `xonsh.proc`

### Features

* add --no-env flag to avoid inheriting parent-shell env ([#5370](https://github.com/jnoortheen/pash/issues/5370)) ([c3a12b2](https://github.com/jnoortheen/pash/commit/c3a12b2a9c2958ce2a8e97a59b41f030f24cb45c))
* add new Rust based parser ([8c79342](https://github.com/jnoortheen/pash/commit/8c79342e65ba10ec13bb7181d20646352d04f967))
* add release-please for conventional-commit based releases ([8a0b315](https://github.com/jnoortheen/pash/commit/8a0b3156a4f2b2377fe0c43d210346557123a2ba))
* add subproc output format, autostrip singleline output ([#5377](https://github.com/jnoortheen/pash/issues/5377)) ([c5cb704](https://github.com/jnoortheen/pash/commit/c5cb7044b53f11fd1bb133469014f409ae074905))
* add superhelp and additional context via new FuncAlias ([#5366](https://github.com/jnoortheen/pash/issues/5366)) ([bb394a8](https://github.com/jnoortheen/pash/commit/bb394a8e84109dff3b0db36bb5a54d1f8cfdca5e))
* allow square brackets in command arguments ([#5326](https://github.com/jnoortheen/pash/issues/5326)) ([5a525e3](https://github.com/jnoortheen/pash/commit/5a525e37891af7af987d3243436cf3667a9b2658))
* **bashpath:** add env-var to allow overriding path to bash ([#5295](https://github.com/jnoortheen/pash/issues/5295)) ([f5ae752](https://github.com/jnoortheen/pash/commit/f5ae75268a7b4af981d4ffba91897e920dfe8f8a))
* **environ:** allow XONSH_*_DIR to be configurable ([#5783](https://github.com/jnoortheen/pash/issues/5783)) ([0292b43](https://github.com/jnoortheen/pash/commit/0292b43e64c72ef16a75128d6346ce7d3b316d66))
* require rust based parser by default ([53655a5](https://github.com/jnoortheen/pash/commit/53655a5daeb8a0f48a7424474b7901a1515a9267))
* start xonfig web from any directory ([6c68541](https://github.com/jnoortheen/pash/commit/6c685417060f70b5e70d02c06e2710100452308a))
* update setting default sub-command for argparser ([a44c20d](https://github.com/jnoortheen/pash/commit/a44c20d805044be08a9fd31232d5db997cdd55ce))
* use uv for installing test deps ([93900e7](https://github.com/jnoortheen/pash/commit/93900e7239972801100dc3f08d9074ac7246db01))


### Bug Fixes

* 5491: more tests ([#5498](https://github.com/jnoortheen/pash/issues/5498)) ([06aca86](https://github.com/jnoortheen/pash/commit/06aca868a288bd462a7dba39dcd91397aabc0a84))
* **abbrevs:** remove incorrect override of carriage return in abbrevs ([#5057](https://github.com/jnoortheen/pash/issues/5057)) ([23c2f20](https://github.com/jnoortheen/pash/commit/23c2f2034dbddb7af48284b945c6590b67ba1c3e))
* **appimage:** quote version bounds in appimage prereqs ([91c18ba](https://github.com/jnoortheen/pash/commit/91c18ba60187068c48e74cb75d9bcae369887d43))
* argparse based completions should work in newer python versions ([#5542](https://github.com/jnoortheen/pash/issues/5542)) ([fa25491](https://github.com/jnoortheen/pash/commit/fa254914d74a2cdf0078bc7c48ffab1beedb6965)), closes [#5471](https://github.com/jnoortheen/pash/issues/5471)
* **ArgparseCompleter:** adjust parsing for upstream private changes ([8a65d4f](https://github.com/jnoortheen/pash/commit/8a65d4f449124796c1a155c37e71409bbc2cb4ac))
* **dirstack:** use XSH.env for $HOME check, not os.path ([#5211](https://github.com/jnoortheen/pash/issues/5211)) ([0fe0a6c](https://github.com/jnoortheen/pash/commit/0fe0a6c03e9deeba3ace0159259d5e51970e462b))
* do not attempt to color traceback for error in xonshrc file ([#5331](https://github.com/jnoortheen/pash/issues/5331)) ([a7688f6](https://github.com/jnoortheen/pash/commit/a7688f647dbbc6aa14e7cb1f7f2b0184d933983a))
* Error in completions with absolute paths ([#5127](https://github.com/jnoortheen/pash/issues/5127)) ([#5328](https://github.com/jnoortheen/pash/issues/5328)) ([a028c72](https://github.com/jnoortheen/pash/commit/a028c72deb9d130fd048805205a58d4f23f48956))
* exception when completing in python-only context ([#5632](https://github.com/jnoortheen/pash/issues/5632)) ([58e2856](https://github.com/jnoortheen/pash/commit/58e2856145dfcb55c8c044ac0b1973cf5f186dd7))
* failing tests on extra space ([80940e8](https://github.com/jnoortheen/pash/commit/80940e8b1ca3a141d372315d8023396ecce6b3d7))
* Fix wrong verification for the simple output, introduced by PR5072 ([#5174](https://github.com/jnoortheen/pash/issues/5174)) ([de74576](https://github.com/jnoortheen/pash/commit/de7457646436256c4d1b5dedc9f260d1c2cf5dca))
* Fixed ``history gc`` invocation failing when ``sqlite`` history … ([#5540](https://github.com/jnoortheen/pash/issues/5540)) ([0f2011d](https://github.com/jnoortheen/pash/commit/0f2011d3028db878460c281ae7010a47ebea10b2))
* handle bg=True ([3d08842](https://github.com/jnoortheen/pash/commit/3d088428bb322ca0ba5c2e11f6bcda5bb1595661))
* handle redirects and & ([7f49769](https://github.com/jnoortheen/pash/commit/7f49769e3ded45ab9d86e32ab61a61637c237013))
* load autoloading (but not yet autoloaded) xontribs ([#5096](https://github.com/jnoortheen/pash/issues/5096)) ([5723317](https://github.com/jnoortheen/pash/commit/572331700b5d0876ffdbd62a5278f0ac1a9c514f))
* ruff linter errors ([b4d196d](https://github.com/jnoortheen/pash/commit/b4d196db17f529249e09b47e9f16ce1871b15752))
* **signals:** fix processing exit signals and exit exception ([#5399](https://github.com/jnoortheen/pash/issues/5399)) ([fd5304f](https://github.com/jnoortheen/pash/commit/fd5304fb8764a9f147dc60f82aec439001364b2b))
* **sqlite:** skip sqlite history tests on windows with python 3.11 ([df8952d](https://github.com/jnoortheen/pash/commit/df8952d99e13492b4a93995c9d57522c8afff312))
* Suppress subprocess traceback in case XONSH_SHOW_TRACEBACK=False and $RAISE_SUBPROC_ERROR=True ([#5066](https://github.com/jnoortheen/pash/issues/5066)) ([0c713a0](https://github.com/jnoortheen/pash/commit/0c713a0c3122a12e5622730ea7c89f81e58537eb))
* trace help on empty args ([b8f91cd](https://github.com/jnoortheen/pash/commit/b8f91cdf221faf81e1d24b76567e196269f6f19f)), closes [#5373](https://github.com/jnoortheen/pash/issues/5373)
* update ptk highlight tests to reflect new tokenizing ([33b2ac0](https://github.com/jnoortheen/pash/commit/33b2ac052b5f67268da25448c4d21c945a51dca0))
* update virtualenv activator ([#5419](https://github.com/jnoortheen/pash/issues/5419)) ([614ddeb](https://github.com/jnoortheen/pash/commit/614ddebc59c8e24647e60acc0d658fe4582c08cb))
* web config overwrite existing value ([c930c9f](https://github.com/jnoortheen/pash/commit/c930c9f2340a098c21852916d1a434fd2639eff5)), closes [#5297](https://github.com/jnoortheen/pash/issues/5297)
* **xpip:** patch in user site packages for xpip where needed ([#5238](https://github.com/jnoortheen/pash/issues/5238)) ([7a5d7c2](https://github.com/jnoortheen/pash/commit/7a5d7c28863baa4f97ea59bb24e4c9f2a3885a6f))


### Reverts

* 5423 ([#5468](https://github.com/jnoortheen/pash/issues/5468)) ([c9046ab](https://github.com/jnoortheen/pash/commit/c9046ab3f6dba6a431e231ef33507759c455c635))


### Documentation

* add news item ([ce215bb](https://github.com/jnoortheen/pash/commit/ce215bb8fe263a88309ccaf5cae8afc843eb4f8c))
* example ([ab779f1](https://github.com/jnoortheen/pash/commit/ab779f188757a47c06c31d2bf84c89cd841b0727))
* fix up api doc paths ([32a0855](https://github.com/jnoortheen/pash/commit/32a085543a7594a39fa61062cbaa06cc540f23fc))
* fix up broken apidocs links ([#5609](https://github.com/jnoortheen/pash/issues/5609)) ([32a0855](https://github.com/jnoortheen/pash/commit/32a085543a7594a39fa61062cbaa06cc540f23fc))
* install xonsh as a core shell ([#5504](https://github.com/jnoortheen/pash/issues/5504)) ([09a89bf](https://github.com/jnoortheen/pash/commit/09a89bf9b40be42386226f1989b5d09e1f24281f))
* link to dev guide and emphasis on solving issues ([#5341](https://github.com/jnoortheen/pash/issues/5341)) ([97b6e1b](https://github.com/jnoortheen/pash/commit/97b6e1ba96c4f259c14e40888b6086b84f3bc4cb))
* more links to xonshrc article ([#5505](https://github.com/jnoortheen/pash/issues/5505)) ([d30d0a5](https://github.com/jnoortheen/pash/commit/d30d0a5446237dda391e6623137cdc8dd0aa0154))
* move section "Use the Nix Package manager with Xonsh" from rc to platform tips and tricks ([#5503](https://github.com/jnoortheen/pash/issues/5503)) ([f9d2842](https://github.com/jnoortheen/pash/commit/f9d2842fb1a0c8b30cd92493bede982694ca8b3a))
* optimize webconfig icon ([#5081](https://github.com/jnoortheen/pash/issues/5081)) ([b2ada58](https://github.com/jnoortheen/pash/commit/b2ada58c0c4e9daca4e03741fb337bce3df8313b))
* remove reduntant table of contents ([#5042](https://github.com/jnoortheen/pash/issues/5042)) ([6cf7865](https://github.com/jnoortheen/pash/commit/6cf78656c76f63b729ddaa03d3a42f14caee7b5c))
* SpecModifierAlias to the tutorial ([#5518](https://github.com/jnoortheen/pash/issues/5518)) ([9343512](https://github.com/jnoortheen/pash/commit/934351254aeb5c857298195c42ee30533e129d23))
* Update bash to xonsh guide ([#5628](https://github.com/jnoortheen/pash/issues/5628)) ([c0e0687](https://github.com/jnoortheen/pash/commit/c0e0687376ed64e07ce95d12f014bf7ea59705e6))
* update comparision ([#5509](https://github.com/jnoortheen/pash/issues/5509)) ([2552ef1](https://github.com/jnoortheen/pash/commit/2552ef17276fae551cbaad9c7cd3eea5526deccd))
* update contribution guide ([2a6e5e1](https://github.com/jnoortheen/pash/commit/2a6e5e15f826a967aba4f7750841842a16eb5613))


### Code Refactoring

* remove ability to load external *.xsh files ([30480f4](https://github.com/jnoortheen/pash/commit/30480f419c8b3b911d816e5116c9f5d3e0296df5))
* remove confusing hook_post_add_argument ([667efce](https://github.com/jnoortheen/pash/commit/667efceb72332ae842bbb2c744379a6eff3e3b5b))
* remove deprecated module `xonsh.proc` ([912c7d3](https://github.com/jnoortheen/pash/commit/912c7d395c35cc7b1db7008f4787eb08cdd0c339))
* remove xonsh.api module ([50e346e](https://github.com/jnoortheen/pash/commit/50e346e107bd0a4498b49c96d8afe49867db3870))
* replace the PLY based parser with the Rust based one ([daef588](https://github.com/jnoortheen/pash/commit/daef58810366f852c3771b50a7acba3e5bd6f571))
